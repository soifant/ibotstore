    ...
    <div class="table-responsive">
        <table id="data" class="table table-striped table-hover tabel">
            <thead>
                <tr>
                    <th>#</th>
                    <th class="text-left">Inv. Order</th>
                    <th>Produk</th>
            ...
            <tbody>
                @foreach($data as $key => $item)
                    <tr>
                        ...
                        <td>
                            <center>
                                <a href="{{ route('pesanan').'?invoice='.$item->inv_order }}" class="btn btn-sm btn-primary" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;"><i class="bi bi-file-earmark-fill"></i></a>
                            </center>
                        </td>
                    </tr>
                @endforeach
        ...
        <div class="mt-3">
            {{ $data->links('pagination::bootstrap-4') }} <!-- Paginasi -->
        </div>
    </div>
</div>
@endsection
